...
str.replacingCharacters(in: str.startIndex..<str.index(str.startIndex, offsetBy: 5), with: "Hi")
str.replacingOccurrences(of: "Hello", with: "Morning")
...
// 另外一个例子
func mutipleOf( _ num1: Int , and num2: Int) -> Int{
    return num1 * num2
}
mutipleOf(4, and: 2)
// multiple of 4 and 2
